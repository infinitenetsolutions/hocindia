...
$about_query1 = "SELECT * FROM `jag_product` where `category`='Mannual Steps & Lifting Key'";
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'tech1')" id="defaultOpen">MANUAL STEPS & LIFTING BAR</button>
...
<div id="tech1" class="tabcontent">
  <h3 class="technologies-title">MANUAL STEPS & LIFTING BAR</h3>
