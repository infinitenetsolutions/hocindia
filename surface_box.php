...
$about_query1 = "SELECT * FROM `jag_product` where `category`='Surface Box'";
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'tech1')" id="defaultOpen">SURFACE BOX & TREE GRATE</button>
...
<div id="tech1" class="tabcontent">
  <h3 class="technologies-title">SURFACE BOX & TREE GRATE</h3>
