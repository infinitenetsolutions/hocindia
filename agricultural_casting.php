...
$about_query1 = "SELECT * FROM `jag_product` where `category`='Agricultural Castings'";
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'tech1')" id="defaultOpen">AGRICULTURAL CASTINGS</button>
